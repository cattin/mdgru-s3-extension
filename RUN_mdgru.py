...
import numpy as np
import sys
from mdgru.data.grid_collection import GridDataCollection, ThreadedGridDataCollection, ThreadedGridDataCollectionS3Storage
...
import setproctitle
setproctitle.setproctitle('mdgru')
...
def run_mdgru(args=None):
    ...
    pre_parameter.add_argument('--gpu', type=int, nargs='+', default="local", help='set gpu ids')
